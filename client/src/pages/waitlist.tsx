      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're carefully selecting families and professional partners for our beta program. 
            Choose the application that best describes your interest in Preserving Connections.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <Card className="border-2 border-purple-200">
            <CardHeader>
              ...
              <CardDescription>
                For funeral directors, estate planners, hospice coordinators, and elder care facilities
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><Clock className="w-4 h-4 mr-2 text-purple-500" />6-month exclusive access</li>
                <li className="flex items-center"><Users className="w-4 h-4 mr-2 text-purple-500" />Co-development of features</li>
                <li className="flex items-center"><Shield className="w-4 h-4 mr-2 text-purple-500" />Revenue sharing opportunity</li>
                <li className="flex items-center"><Building className="w-4 h-4 mr-2 text-purple-500" />White-label demo ready</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-indigo-200">
            <CardHeader>
              <CardTitle className="flex items-center text-indigo-700">
                ...
                Family Feedback Track
              </CardTitle>
              <CardDescription>
                For families who have experienced loss and are willing to provide detailed feedback
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><Heart className="w-4 h-4 mr-2 text-indigo-500" />Free platform access</li>
                <li className="flex items-center"><Shield className="w-4 h-4 mr-2 text-indigo-500" />Professional support available</li>
                <li className="flex items-center"><Users className="w-4 h-4 mr-2 text-indigo-500" />Weekly feedback sessions</li>
                <li className="flex items-center"><Clock className="w-4 h-4 mr-2 text-indigo-500" />Shape the future of grief tech</li>
              </ul>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="partner" className="text-lg py-3">
              Professional Partner Application
            </TabsTrigger>
            <TabsTrigger value="family" className="text-lg py-3">
              Family Feedback Application
            </TabsTrigger>
          </TabsList>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <Card className="border-green-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Professional counselor review of all applications. Regular mental health check-ins during testing.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                We prioritize quality over quantity, selecting committed participants who can provide meaningful feedback.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                We treat this like recruiting for a clinical trial, with proper consent processes and safety protocols.
              </p>
            </CardContent>
          </Card>
        </div>
